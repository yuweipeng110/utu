...
const StrategyDeployStep45: React.FC<StrategyDeployStep50Props> = (props) => {
  const {
    setLoading,
  ...
  const nextDis =
    ...
    currentAppDeployData?.status === 355
      ? false
      : true;
  ...
  return (
    <ProCard
      ...
      extra={
        <Space size="large">
          {currentAppDeployData?.originalStage === 699 && !buildIsStart && (
    ...
    >
      <ProForm
        ...
        submitter={{
          render: (props) => {
            if (!_.isEmpty(currentAppDeployData) && currentAppDeployData?.originalStage === 699) {
              return (
      ...
      >
        ...
        <Card
          ...
          extra={
            <Space size="large">
              {currentAppDeployData?.originalStage === 699 && (
                <>
                  <Button
                    type="primary"
                    onClick={buildAndDeployRequest}
                    disabled={currentAppDeployData.status === 355 || buildIsStart}
                  >
                    部署日常
                  </Button>
                </>
...
export default StrategyDeployStep45;
