...
export type RollbackStrategyDeployStep30Props = {
  setLoading: any;
...
// 泰坦变更
const RollbackStrategyDeployStep30: React.FC<RollbackStrategyDeployStep30Props> = (props) => {
  const {
    setLoading,
    ...
    formatResult: (res) => {
      ...
      const options: any = res.data.map((item: any) => {
        ...
        return {
          ...
          // {
          //   empId: item.empId,
          //   nickNameCn: item.nickName,
          //   realNameCn: item.empName,
          // },
          label,
          optionLabel,
        };
...
export default RollbackStrategyDeployStep30;
